...
https://dev.axiomide.com/marketplace/christiangeorgelucas/color-tools@0.1.0
...
```bash
axiom invoke christiangeorgelucas/color-tools/Convert --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/color-tools/0.1.0/Convert \
...
> `axiom inspect node christiangeorgelucas/color-tools/Convert`.
